...
public class StudentSeminarsFrame extends JFrame {
  ...
  public StudentSeminarsFrame(AuthController authController) {
  ...
  private void viewSelectedSeminar() {
    ...
    new StudentSeminarDetailFrame(authController, seminarId);
  }
}